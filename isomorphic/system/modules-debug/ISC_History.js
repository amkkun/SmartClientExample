...
isc.version = "v8.3p_2013-06-16/LGPL Deployment";
isc.versionNumber = "v8.3p_2013-06-16";
isc.buildDate = "2013-06-16";
isc.expirationDate = "";
...
//       <pre>    &lt;script type="text/javascript" charset="UTF-8" language="JavaScript" src="cordova-2.1.0.js"&gt;&lt;/script&gt;</pre>
//
...
// which means that the domain of SOMEURL has not been added to <code>ExternalHosts</code> in <code>Cordova.plist</code>.
...
//        scriptName = "cordova-2.1.0-android.js";
//    } else if (isc.Browser.isIPad || isc.Browser.isIPhone) {
//        scriptName = "cordova-2.1.0-iOS.js";
//    }
...
// is a WebKit-based browser or Firefox, but not Internet Explorer 9.  If isc_css3Mode is set
...
{
    isc.Browser.useCSS3 = (isc.Browser.isWebKit || isc.Browser.isFirefox);
} else {
    isc.Browser.useCSS3 = false;
}
