...
else isc._preLog=[isc._pTM]}isc.definingFramework=true;isc.defineClass("RobotServerPicker","Window");
isc.A=isc.RobotServerPicker.getPrototype();
isc.B=isc._allFuncs;
...
isc.A.autoSize=true;
isc.A.isModal=true;
isc.A.title="Select Robot Server";
isc.A.formConstructor="DynamicForm";
isc.A.formDefaults={
    width:300,
    numCols:2,
    colWidths:[150,"*"],
...
isc.A.myAutoChildren=["form"];
isc.B.push(isc.A.initWidget=function isc_RobotServerPicker_initWidget(){
    this.Super("initWidget",arguments);
    this.form=this.createAutoChild("form");
    this.addItem(this.form);
}
,isc.A.nextClick=function isc_RobotServerPicker_nextClick(){
